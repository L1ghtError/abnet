...
#ifndef ABNET_WINSOCK_INIT_HPP
#define ABNET_WINSOCK_INIT_HPP
...
protected:
  ...
  ABNET_DECL static void startup(data &d, unsigned char major, unsigned char minor);

  ABNET_DECL static void manual_startup(data &d);

  ABNET_DECL static void cleanup(data &d);

  ABNET_DECL static void manual_cleanup(data &d);

  ABNET_DECL static void throw_on_error(data &d);
};
...
public:
  ...
  // constructors.
  //
  // To prevent abnet from initialising Winsock, the object must be constructed
  ...
  //   #pragma init_seg(lib)
  //   abnet::detail::winsock_init<>::manual manual_winsock_init;
  //   #pragma warning(pop)
  class manual {
  public:
